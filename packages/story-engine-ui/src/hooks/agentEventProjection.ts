...
const TOOL_PRESENTATION: Record<string, ToolPresentation> = {
  ...
  read_draft: { stepLabel: "读取工作稿原文", card: null },
  // 写资料
  foundation_write: {
    stepLabel: "更新故事资料",
  ...
  // 做厚资料簇
  generate_worldbuilding: { stepLabel: "补全世界观", card: null },
  generate_asset_enrichment: { stepLabel: "补全道具与资源", card: null },
  generate_location_enrichment: { stepLabel: "补全地点", card: null },
  generate_character_enrichment: { stepLabel: "补全角色", card: null },
  generate_matrix_enrichment: { stepLabel: "补全角色关系", card: null },
  generate_character_relationships: { stepLabel: "整理角色关系", card: null },
  generate_writing_rules_enrichment: { stepLabel: "重新整理写作规则", card: null },
  generate_alias_table: { stepLabel: "补全别名表", card: null },
  // 正文簇
  generate_chapter_steering: { stepLabel: "生成章节方向", card: null },
  generate_draft: { stepLabel: "生成正文", card: null },
  revise_draft: { stepLabel: "修改工作稿", card: null },
  // 审校簇
